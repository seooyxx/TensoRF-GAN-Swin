...
def reconstruction(args):
    ...
    # from gaussian, extract some latent vectors for appearance and shape
    #shape code z_s is determined the shape of object
    z_s = torch.randn(nSamples, n_lamb_sigma, device=device)
    # appearance code z_a is determined the color of object
    z_a = torch.randn(nSamples, n_lamb_sh, device=device)
